 ...
 * method calls.
 * <p>
 * An UnsynchronizedStringBuffer is NOT thread safe.  This is the major difference
 * between java.lang.StringBuffer's and this one.
 * <p>
 * The principal operations on a <code>UnsynchronizedStringBuffer</code> are the
 ...
 * <p>
 * In general, if sb refers to an instance of a <code>UnsynchronizedStringBuffer</code>,
...
public final class UnSyncStringBuffer {
	 ...
	 */
	public UnSyncStringBuffer(java.lang.String str) {
		this(str.length() + 16);
		append(str);
	}
	...
	/**
	 * This implements the expansion semantics of ensureCapacity.
	 *
	...
	/**
	 * Clear the string buffer, retaining any backing storage.  Any remaining
	 * storage is not made available for garbage collection and is ready to be
	 * reused in the buffer.  This is
	 * a special case of setLength(0) that skips checking.
	 */
	public void clear() {
		count = 0;
	}
	...
	/**
	 * This method returns the underlying char[].  Its use is
	 * dangerous and only provided to be used in situations where multiple
	 * calls to charAt() provides unacceptable performance.  Use at your
	 * own risk.
	 * @return the live char[] backing storage for this buffer
	 */
	public char[] get() {
		return value;
	}
	 ...
	 * @return  a reference to this <code>UnsynchronizedStringBuffer</code> object.
	 ...
	 *
	 * @param   str   a string.
	 * @return  a reference to this <code>UnsynchronizedStringBuffer</code>.
	 */
	...
	/**
	 * Appends the specified <tt>UnsynchronizedStringBuffer</tt> to this
	 * <tt>UnsynchronizedStringBuffer</tt>.
	 * <p>
	 * The characters of the <tt>UnsynchronizedStringBuffer</tt> argument are appended,
	 * in order, to the contents of this <tt>UnsynchronizedStringBuffer</tt>, increasing the
	 * length of this <tt>UnsynchronizedStringBuffer</tt> by the length of the argument.
	 * If <tt>sb</tt> is <tt>null</tt>, then the four characters
	 * <tt>"null"</tt> are appended to this <tt>UnsynchronizedStringBuffer</tt>.
	 * <p>
	 * Let <i>n</i> be the length of the old character sequence, the one
	 * contained in the <tt>UnsynchronizedStringBuffer</tt> just prior to execution of the
	 ...
	 * <tt>UnsynchronizedStringBuffer</tt> with the new buffer length as its argument.
	 * (This ensures that the storage of this <tt>UnsynchronizedStringBuffer</tt> is
	 * adequate to contain the additional characters being appended.)
	 *
	 * @param   sb         the <tt>UnsynchronizedStringBuffer</tt> to append.
	 * @return  a reference to this <tt>UnsynchronizedStringBuffer</tt>.
	 */
	public UnSyncStringBuffer append(UnSyncStringBuffer sb) {
		if (sb == null) {
			sb = NULL;
		}
		int len = sb.length();
	...
	private static final UnSyncStringBuffer NULL = new UnSyncStringBuffer("null");
	 ...
	 * @return  a reference to this <tt>UnsynchronizedStringBuffer</tt>.
	 */
	public UnSyncStringBuffer append(StringBuffer sb) {
		if (sb == null) {
			return append((UnSyncStringBuffer) null);
		}
		int len = sb.length();
		int newcount = count + len;
		if (newcount > value.length) {
	 ...
	 * to this <code>UnsynchronizedStringBuffer</code> object.
	 *
	 ...
	 * <code>UnsynchronizedStringBuffer</code> object.
	 *
	...
	/**
	 * Removes the characters in a substring of this <code>UnsynchronizedStringBuffer</code>.
	 * The substring begins at the specified <code>start</code> and extends to
	 * the character at index <code>end - 1</code> or to the end of the
	 * <code>UnsynchronizedStringBuffer</code> if no such character exists. If
	 ...
	 */
	public UnSyncStringBuffer delete(int start, int end) {
		if (start < 0) {
	 ...
	 * <code>UnsynchronizedStringBuffer</code> (shortening the <code>StringBuffer</code>
	 * by one character).
	 *
	 ...
	 *            <code>length()</code>.
	 */
	public UnSyncStringBuffer deleteCharAt(int index) {
		if ((index < 0) || (index >= count)) {
			throw new StringIndexOutOfBoundsException();
		}
	...
	/**
	 * Replaces the characters in a substring of this <code>UnsynchronizedStringBuffer</code>
	 * with characters in the specified <code>String</code>. The substring
	 * begins at the specified <code>start</code> and extends to the character
	 * at index <code>end - 1</code> or to the end of the
	 * <code>UnsynchronizedStringBuffer</code> if no such character exists. First the
	 * characters in the substring are removed and then the specified
	 * <code>String</code> is inserted at <code>start</code>. (The
	 * <code>UnsynchronizedStringBuffer</code> will be lengthened to accommodate the
	 ...
	 *           greater than <code>end</code>.
	 */
	public UnSyncStringBuffer replace(int start, int end, String str) {
		if (start < 0) {
			throw new StringIndexOutOfBoundsException(start);
		}
		if (end > count) {
	 ...
	 * characters currently contained in this <code>UnsynchronizedStringBuffer</code>.The
	 * substring begins at the specified index and extends to the end of the
	 * <code>UnsynchronizedStringBuffer</code>.
	 *
	 * @param      start    The beginning index, inclusive.
	 ...
	 * <code>UnsynchronizedStringBuffer</code> increases by <code>len</code> characters.
	 *
	 ...
	 */
	public UnSyncStringBuffer insert(int index, char[] str, int offset, int len) {
		if ((index < 0) || (index > count)) {
			throw new StringIndexOutOfBoundsException();
		}
	 ...
	 * <code>UnsynchronizedStringBuffer</code>  object at the position indicated by
	 * <code>offset</code>.
	 *
	 * @param      offset   the offset.
	 * @param      str      a character array.
	 ...
	 * this <code>UnsynchronizedStringBuffer</code> object at the position indicated by
	 * <code>offset</code>.
	 * <p>
	 * The offset argument must be greater than or equal to
	 * <code>0</code>, and less than or equal to the length of this
