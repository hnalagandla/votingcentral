...
%>
<html:form action="/recEndedPolls">
    
<div style="padding:0px 0px 10px 0px;"> 
<table border="0" cellpadding="0" cellspacing="1" width="100%" class="lightbluebg">
	<tr>
		<td valign="middle" bgcolor="#FFFFFF">
		<div id="blueTitle"><bean:message key="rec.ended.polls.heading"/></div>
       	<div id="bulletBox">
		<!-- Content Start -->
				<logic:present name="recEndedPollsFormBean" property="recEndedPolls" >											
				<table width="100%" cellspacing="0" cellpadding="0" border="0">
				<logic:iterate id="pto" name="recEndedPollsFormBean" property="recEndedPolls" type="com.votingcentral.pres.web.to.PollWTO">																					
